<footer class="bg-dark bd-footer py-3 py-md-3 mt-5">
    <div class="container-xxl bd-gutter mt-3 bd-layout py-4 py-md-5 text-white">
        <div class="row">
            <div class="col-lg-3 mb-3">
                <a class="d-inline-flex align-items-center mb-2 text-body-emphasis text-decoration-none" href="/"
                   aria-label="Bootstrap">
                    <img src="{{asset('images/brand.png')}}" alt="brand"
                         height="32" class="rounded me-2">
                    <span class="fs-5 text-white">SanninStore</span>
                </a>
                <ul class="list-unstyled small">
                    ...
                    <li class="mb-2">2024 © SanninStore - Made by TamPhucHuy</li>
                </ul>
            </div>
            ...
            <div class="col-6 col-lg-2 mb-3">
                <h5>Projects</h5>
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="https://github.com/twbs/bootstrap" target="_blank" rel="noopener">Bootstrap
                            5</a></li>
