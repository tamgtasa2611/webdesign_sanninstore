...
<div id="content" class="">
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div class="justify-content-center mt-5" style="width: 520px">
            <h4 class="fs-1 text-center">Edit Country #{{$country->id}}</h4>
                        ...
                        <div class="row justify-content-between w-100 pl-5">
                            <div class="col-5">
                                <div class="input-group">
                                    <label class="col-form-label text-dark font-monospace">Country Name</label>
                                    <input class="rounded-3 px-3 " type="text" name="country_name"
                                           pattern="[A-Za-z]+"
